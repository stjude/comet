### NB MYCN amplification (binary) — methylation classification, thin wrapper around
### core_code/methylation_tumor_classification_core.py. Same design as
### tumor_classification/run_methylation_tumor_classification.py: reads a train/test
...
###   python run_nb_mycn_methylation_classification.py --methylation-reps ../data/meth_top5000_sample_reps.p --n-splits 5   # quick test
...
TEMP_DIR=os.path.join(SCRIPT_DIR,'temp_nb_mycn_methylation_csv')
...
def main():
    ap=argparse.ArgumentParser(description='NB MYCN amplification — methylation classification wrapper')
    ...
    ap.add_argument('--out',default='nb_mycn_methylation_results.p')
