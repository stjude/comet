### NB MYCN amplification (binary) MIL classification — thin wrapper around
### core_code/mil_classification_core.py (3 MIL architectures x 3 hyperparameter variants
### = 9 model/variant combinations, trained on tile-level UNI-v2 features; see
...
### the core's RMS default. Same design as RMSsubtyping/run_rms_subtype_mil.py: reads a
...
###   python run_nb_mycn_mil.py --tiles-dir ../data/NB_tiles --n-splits 5   # quick test
###   python run_nb_mycn_mil.py --tiles-dir ../data/NB_tiles --device cuda  # force GPU
...
TEMP_DIR=os.path.join(SCRIPT_DIR,'temp_nb_mycn_mil_csv')
...
def main():
    ap=argparse.ArgumentParser(description='NB MYCN amplification MIL (tile-level) classification wrapper')
    ...
    ap.add_argument('--out',default='nb_mycn_mil_results.p')
