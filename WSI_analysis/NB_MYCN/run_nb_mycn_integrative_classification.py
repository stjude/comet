### NB MYCN amplification (binary) — integrative (WSI+methylation) classification, thin
### wrapper around core_code/integrative_tumor_classification_core.py. Same design as
### tumor_classification/run_integrative_tumor_classification.py: reads a train/test
...
###   python run_nb_mycn_integrative_classification.py \
###     --sampler-reps ../data/univ2_20x_sample_reps.p \
###     --methylation-reps ../data/meth_top5000_sample_reps.p --n-splits 5   # quick test
...
TEMP_DIR=os.path.join(SCRIPT_DIR,'temp_nb_mycn_integrative_csv')
...
def main():
    ap=argparse.ArgumentParser(description='NB MYCN amplification — integrative (WSI+methylation) classification wrapper')
    ...
    ap.add_argument('--out',default='nb_mycn_integrative_results.p')
